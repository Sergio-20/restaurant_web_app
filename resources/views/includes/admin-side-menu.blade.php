            ...
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4"
                        aria-controls="submenu-4"><i class="fa fa-fw fa-rocket"></i>Customers</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3"
                        aria-controls="submenu-3"><i class="fa fa-fw fa-rocket"></i>Users</a>
                    <div id="submenu-3" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/create">Create User <span
                                        class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                    </div>
